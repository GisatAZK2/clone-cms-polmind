...
jQuery(function ($) {
    ...
    if (cookieNotice && typeof gdprCookieNoticeLocales !== 'undefined' && typeof gdprCookieNotice === 'function') {

        // Ensure gdpr cookie globals exist to avoid ReferenceError
        if (typeof window.gdprCookieNoticeLocales === 'undefined') {
            window.gdprCookieNoticeLocales = {};
        }

        if (typeof window.gdprCookieNotice !== 'function') {
            window.gdprCookieNotice = function (opts) {
                // fallback no-op: library not loaded
                console.warn('gdprCookieNotice library not loaded; skipping cookie UI.');
                return;
            };
        }
